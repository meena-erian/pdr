def make_query(query_name, *args):
    """
    A function used to generate SQL code from SQL templates saved in the SQL folder. 
...
def exec_query(engine, query_name, *args):
    """
    A wrapper function for make_query where in addition to generating SQL code using make_query
    it also excecutes the code using provided engine.
    """
...
def make_script(script_name, *args):
    """
    A function used to generate JavaScript code based on the JavaScript templates in the
    js folder. For more information see reflector/js/README.MD
    """
    import os
    import reflector
